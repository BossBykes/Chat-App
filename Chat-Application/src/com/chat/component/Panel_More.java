...
import com.chat.emoji.Emogi;
import com.chat.emoji.Model_Emoji;
import com.chat.event.PublicEvent;
import com.chat.main.Main;
...
import com.chat.swing.WrapLayout;
...
//        panelHeader.add(getButtonFile());
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/chat/icon/link.png")));
...
//    }
    ...
    private boolean isImageFile(File file) {
        ...
        return name.endsWith(".pdf") || name.endsWith(".txt") || name.endsWith(".jpg") || name.endsWith(".png") || name.endsWith(".jpeg") || name.endsWith(".gif");
    }
